...
wsl bash -c "sudo -u martes bash -c 'if [ ! -d ~/martes_setup ]; then git clone https://github.com/Profu-AB/martes_setup.git ~/martes_setup; else cd ~/martes_setup && git pull; fi'"
